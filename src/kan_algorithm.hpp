...
public:
	...
	virtual void run(const int c, std::size_t &current_computing_c, std::vector<int> parameters) = 0;
};
...
public:
	...
	void run(const int c, std::size_t& current_computing_c, std::vector<int> parameters);
};
